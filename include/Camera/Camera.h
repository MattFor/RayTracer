...
private:
    ...
    Ray get_ray (int height, int width) const;

    // Determines the colour of a given pixel using the ray bounce history
    static Color ray_clr (const Ray&, int depth, const Intersectable& scene);
};
